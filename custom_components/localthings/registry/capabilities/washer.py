...
# Table_02 family (issue #363). Two code pairs ('21'/'65' Colors,
# '27'/'5E' Rinse+Spin, and '24'/'54' Towels) legitimately share a label
# across different course tables -- not typos.
#
